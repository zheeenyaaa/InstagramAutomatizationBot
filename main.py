...
from data import user_settings_dict, direct_users_list

class InstagramBot():
    '''
        Instagram Bot making different things
    '''
    def __init__(self, username, password):
        ...
        service = Service(executable_path="C:\\Create\\code\\programming\\study\\selenium\\selenium_bot_instagram(PythonToday)\\chromedriver\\chromedriver.exe")
    ...
    def like_photo_by_hashtag(self, hashtag):
        ...
        for url in posts_urls:
            try:
                ...
                like_button = browser.find_element("xpath", "/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/div[1]/div[2]/section/main/div/div[1]/div/div[2]/div/div[3]/div[1]/div[1]/span[1]/div/div").click()
    ...
    # проверям, существует ли элемент по xpath на странице
    ...
    def put_exactly_like(self, userpost):
        ...
        if self.xpath_exists(wrong_userpage):
            ...
            like_button = "/html/body/div[12]/div[1]/div/div[3]/div/div/div/div/div[2]/div/article/div/div[2]/div/div/div[2]/section[1]/span[1]/div"
            try:
    ...
    def get_all_posts_urls(self, userpage):
        ...
        if self.xpath_exists(wrong_userpage):
            ...
            posts_count_str = browser.find_element("xpath", "/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/div[1]/div[2]/div[2]/section/main/div/header/section/ul/li[1]/span/span").text
            posts_count = int(''.join(posts_count_str.split(' ')))
            loops_count = int(posts_count/12)
            print(loops_count)

            posts_urls = []

            # вместо 4 надо подставить loops_count
            for i in range(4):
                hrefs = browser.find_elements("tag name", 'a')
                hrefs_of_posts = [item.get_attribute('href') for item in hrefs if '/p/' in item.get_attribute('href')]

                for href in hrefs_of_posts:
            ...
            with open(f'{file_name}/{file_name}_set.txt', 'a') as file:
    ...
    def put_many_likes(self, userpage):
        ...
        with open(f'{file_name}/{file_name}_set.txt') as file:
            ...
            for post_url in urls_list[0:4]:
                try:
                    ...
                    try:
                        ...
                        print("Ошибка! Не удалось поставить лайк!")
    ...
    # скачиваем весь контент со страницы пользователя
        ...
        with open(f'{file_name}/{file_name}_set.txt') as file:
            ...
            for post_url in urls_list[0:5]:
                try:   
                    ...
                    img_src = "/html/body/div[12]/div[1]/div/div[3]/div/div/div/div/div[2]/div/article/div/div[1]/div/div[1]/div[2]/div/div/div/ul/li[2]/div/div/div/div/div[1]/img"
                    video_src = "/html/body/div[12]/div[1]/div/div[3]/div/div/div/div/div[2]/div/article/div/div[1]/div/div/div/div/div/div/div/video"
    ...
    def get_all_followers(self, userpage):
        ...
        if self.xpath_exists(wrong_userpage):
            ...
            followers_button = browser.find_element("xpath", "/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/div[1]/div[2]/div[2]/section/main/div/header/section/ul/li[2]/a/span/span")
            ...
            # еслик колво подписчиков больше 999
            ...
            followers_ul = "/html/body/div[10]/div[1]/div/div[2]/div/div/div/div/div[2]/div/div/div[3]/div[1]"
            try:
                followers_urls = []
                ...
                #all_urls_div = followers_ul.find_element("tag name", "li")
                all_urls_div = browser.find_elements("xpath", "/html/body/div[10]/div[1]/div/div[2]/div/div/div/div/div[2]/div/div/div[3]/div[1]/div/div[4]")
                

                for url in all_urls_div:
                    url = browser.find_element("xpath", "/html/body/div[10]/div[1]/div/div[2]/div/div/div/div/div[2]/div/div/div[3]/div[1]/div/div[1]/div/div/div/div[2]/div/div/div/div/div/a").get_attribute('href')
                ...
                with open(f"{file_name}/{file_name}.txt") as text_file:
                    ...
                    for user in users_urls[0:10]:
                        try:
                            ...
                            if self.xpath_exists("/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/div[1]/div[2]/div[2]/section/main/div/header/section/div[1]/div[1]/div/div[1]/a"):
                                print("Это наш профиль, уже подписан, пропускаем итерацию!")
                            elif self.xpath_exists(
                                    "/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/div[1]/div[2]/div[2]/section/main/div/div[1]/a[1]/div/span"):
                                ...
                                if self.xpath_exists(
                                        "/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/div[1]/div[2]/div[2]/section/main/div/div/article/div/div/h2"):
                                    try:
                                        follow_button = browser.find_element("xpath",
                                            "/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/div[1]/div[2]/div[2]/section/main/div/header/section/div[1]/div[1]/div/div/button/div/div").click()
                                        print(f'Запросили подписку на пользователя {page_owner}. Закрытый аккаунт!')
                                    except Exception as ex:
                                        print(ex)
                                else:
                                    try:
                                        if self.xpath_exists("/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/div[1]/div[2]/div[2]/section/main/div/header/section/div[1]/div[1]/div/div/button/div/div"):
                                            follow_button = browser.find_element("xpath", "/html/body/div[2]/div/div/div[2]/div/div/div/div[1]/div[1]/div[2]/div[2]/section/main/div/header/section/div[1]/div[1]/div/div/button/div/div").click()
                                            print(f'Подписались на пользователя {page_owner}. Открытый аккаунт!')
                                        else:
                                            follow_button = browser.find_element("xpath", "/html/body/div[1]/section/main/div/header/section/div[1]/div[1]/div/span/span[1]/button").click()
                                            print(f'Подписались на пользователя {page_owner}. Открытый аккаунт!')
                                    except Exception as ex:
                                        print(ex)
    ...
    def send_direct_message(self, usernames="", message="", img_path=""):
        ...
        if not self.xpath_exists(direct_message_button):
            print("Кнопка отправки сообещний не найден!")
            self.close_browser()
        else:
            print("Отправляем сообещние...")
            direct_message = browser.find_element("xpath", direct_message_button).click()
            time.sleep(random.randrange(2, 4))
        ...
        send_message_button = browser.find_element("xpath", 
        ...
        for user in usernames:
            ...
            to_input = browser.find_element("xpath", "/html/body/div[5]/div/div/div[2]/div[1]/div/div[2]/input")
            to_input.send_keys(user)
            time.sleep(random.randrange(2, 4))
            
            # выбираем получателя из списка
            users_list = browser.find_element("xpath", "/html/body/div[5]/div/div/div[2]/div[2]").find_element("tag name", "button").click()
            time.sleep(random.randrange(2, 4))
        
        next_button = browser.find_element("xpath",
        ...
        if message:
            ...
            text_message_area = browser.find_element("xpath", 
        ...
        if img_path:
            send_img_input = browser.find_element("xpath", "/html/body/div[1]/section/div/div[2]/div/div/div[2]/div[2]/div/div[2]/div/div/form/input")
    ...
    def unsubscribe_for_all_users(self, userpage):
        ...
        following_button = browser.find_element("xpath", "/html/body/div[1]/section/main/div/header/section/ul/li[3]/a")
        following_count = following_button.find_element("tag name", "span").text
        ...
        for loop in range(1, loops_count + 1):
            ...
            following_div_block = browser.find_element("xpath", "/html/body/div[5]/div/div/div[2]/ul/div")
            following_users = following_div_block.find_element("tag name", "li")
            time.sleep(random.randrange(3, 6))
            ...
            for user in following_users:
                ...
                user_url = user.find_element("tag name", "a").get_attribute("href")
                ...
                following_button = user.find_element("tag name", "button").click()
                time.sleep(random.randrange(3, 6))
                
                unfollow_button = browser.find_element("xpath", "/html/body/div[6   ]/div/div/div/div[3]/button[1]").click()
    ...
    # метод отписки от всех кто не подписан на нас
    def smart_unsubscribe(self, username):
        ...
        followers_button = browser.find_element("xpath", "/html/body/div[1]/section/main/div/header/section/ul/li[2]/a/span")
        followers_count = followers_button.get_attribute("title")
        ...
        followers_ul = browser.find_element("xpath", "/html/body/div[7]/div/div/div[2]")
        ...
        try:
            ...
            for url in all_urls_div:
                url = url.find_element("tag name", "a").get_attribute("href")
                followers_urls.append(url)
        ...
        following_button = browser.find_element("xpath", "/html/body/div[2]/section/main/div/header/section/ul/li[3]/a")
        following_button.click()
        time.sleep(random.randrange(3, 5))

        following_ul = browser.find_element("xpath", "/html/body/div[7]/div/div/div[2]")
        ...
        try:
            ...
            all_urls_div = following_ul.find_element("tag name", "li")
            ...
            try:
                ...
                for user_url in unfollow_users_list:
                    ...
                    unfollow_button = browser.find_element("xpath", "/html/body/div[2]/section/main/div/header/section/div[1]/div[1]/div/div[2]/div/span/span[1]/button")
                    unfollow_button.click()

                    time.sleep(random.randrange(4, 6))

                    # подтверждение отписки
                    unfollow_button_confirm = browser.find_element("xpath", "/html/body/div[7]/div/div/div/div[3]/button[1]")
...
for user, user_data in user_settings_dict.items():
    ...
    my_bot.login()
    # my_bot.like_photo_by_hashtag("ukraine") work well
    #my_bot.put_exactly_like("https://www.instagram.com/p/Cw4vnOsoYwR/") # throw error
    #my_bot.get_all_posts_urls("https://www.instagram.com/forbes.russia/") #work well
    #my_bot.put_many_likes("https://www.instagram.com/forbes.russia/") #work well but cant push like
    #my_bot.download_userpage_content("https://www.instagram.com/forbes.russia/") # work well but cant download img and video(not find xpath in page)
    my_bot.get_all_followers("https://www.instagram.com/zarinsta_/")

    #my_bot.get_all_followers("https://www.instagram.com/pro.finansy/")
    # my_bot.close_browser()
    # my_bot.send_direct_message(direct_users_list, "how are you?", "C:\\Creating\\Код\\Программирование\\Учеба\\selenium\\3selenium_bot_instagram\\image.jpg")
    # my_bot.unsubscribe_for_all_users("connolly.mykhailo54200")
    #my_bot.smart_unsubscribe("connolly.mykhailo54200")
    time.sleep(5)


# my_bot.send_direct_message(direct_users_list, "how are you?", "C:\\Creating\\Код\\Программирование\\Учеба\\selenium\\3selenium_bot_instagram\\image.jpg")
# my_bot.get_all_followers("https://www.instagram.com/lagutkina_2233/")
# my_bot.download_userpage_content("https://www.instagram.com/camerons_chinchillas/")
